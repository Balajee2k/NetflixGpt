...
const GptSearchBar = () => {
    ...
    return (
        <div className='pt-[25%] sm:pt-[15%] md:pt-[10%] flex justify-center px-4'>
            <form className='w-full sm:w-3/4 md:w-1/2 bg-black grid grid-cols-12'
            ...
            >
                <input
                    ...
                    className='border p-4 m-4 col-span-9 bg-gray-700 text-white' />
                <button
